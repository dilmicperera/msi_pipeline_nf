...
if os.path.basename(msisensor_output_file).replace('.hardclipped.msisensor','') == os.path.basename(mantis_output_file).replace('.hardclipped.mantis.status',''):

    sample_name = os.path.basename(msisensor_output_file).replace('.hardclipped.msisensor','')
